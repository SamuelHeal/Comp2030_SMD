...
<body>
    <?php
        ...
        // Reformats to the format required for the datetime input
    ...
    <div id=body-container-small>
        ...
        <?php 
            ...
            echo '<div id="machines-button-container">';
                echo '<button class="machines-button" onclick="addSubtractMins(-30)">- 30 Mins</button>';
                echo '<div class="factory-button-wrapper" id="datetime-inp-wrapper">';
